...
- Added [docs/PH-J5-VS-POOL-STATION-ADS.md](docs/PH-J5-VS-POOL-STATION-ADS.md):
  count→volt migration, live NVS 2-point `(1.602→4, 3.406→7.4)` vs j5
  2.43 V @ 7.4, and ADS1115 **gain 4.096 rail** at 4.094 V (published
  ≈ 8.71). j5 source: github.com/echavet/j5_ha_bridge (`applyCalibration`).
...
- Example ADS comments: 4.096 saturates ≥ 4.096 V; prefer 6.144 for 5 V
  isolators.
